            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h1 class="mb-5 display-3 text-primary">Veggies & Fruits</h1>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">Rp4.99 / kg</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-secondary rounded border border-secondary">
                                <img src="img/diskon.jpg" class="img-fluid rounded-top w-100" alt="">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img src="img/kentang3.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
