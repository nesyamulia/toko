                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        ...
                                                        <a href="{{ route('category.index', ['category_id' => '1']) }}"
                                                            class="{{ request()->get('category_id') == '1' ? 'active' : '' }}">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        ...
                                                        <a href="{{ route('category.index', ['category_id' => '2']) }}"
                                                            class="{{ request()->get('category_id') == '2' ? 'active' : '' }}">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-4">
                                            <div class="rounded position-relative fruite-item">
                                                <a href="{{ route('single-product', ['id' => $product->id]) }}">
                                                    <!-- Tautan ke halaman single-product -->
