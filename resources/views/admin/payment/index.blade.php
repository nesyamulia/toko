            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="{{ route('payment.create') }}" class="btn btn-primary">Add New Item</a>
                        <h6>Payment Table</h6>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a href="{{ route('payment.edit', $payment->id) }}" class="badge badge-sm bg-gradient-success">Edit</a>
                                            <a href="#" onclick="event.preventDefault(); confirmDelete('{{ $payment->id }}')" class="badge badge-sm bg-gradient-danger">Delete</a>
