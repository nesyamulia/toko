            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="{{ route('order-detail.create') }}" class="btn btn-primary">Add New Item</a>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Order</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $orderDetail->order->order_date }}</td>
                                        <td class="text-center">{{ $orderDetail->quantity }}</td>
                                        <td class="text-center">{{ $orderDetail->subtotal }}</td>
