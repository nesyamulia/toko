    ...
    <form class="register-form" method="POST" action="{{ route('customer.register') }}">
        ...
        <div class="form-wrap">
            <div class="form-inner mb-5">
                ...
                <!-- Kolom Telepon -->
<div class="form-floating">
    <input id="phone" type="text" name="phone" placeholder="Full phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus class="form-control @error('phone') is-invalid @enderror">
...
<!-- Alamat 1 -->
<div class="form-floating">
    <input id="address1" type="text" name="address1" placeholder="Full address1" value="{{ old('address1') }}" required autocomplete="address1" autofocus class="form-control @error('address1') is-invalid @enderror">
...
<!-- Alamat 2 -->
<div class="form-floating">
    <input id="address2" type="text" name="address2" placeholder="Full address2" value="{{ old('address2') }}" required autocomplete="address2" autofocus class="form-control @error('address2') is-invalid @enderror">
...
<!-- Alamat 3 -->
<div class="form-floating">
    <input id="address3" type="text" name="address3" placeholder="Full address3" value="{{ old('address3') }}" required autocomplete="address3" autofocus class="form-control @error('address3') is-invalid @enderror">
