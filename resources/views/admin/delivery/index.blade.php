            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="{{ route('delivery.create') }}" class="btn btn-primary">Add New Item</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a href="{{ route('delivery.edit', $delivery->id) }}" class="badge badge-sm bg-gradient-success">Edit</a>
                                            <a href="#" onclick="event.preventDefault(); confirmDelete('{{ $delivery->id }}')" class="badge badge-sm bg-gradient-danger">Delete</a>
