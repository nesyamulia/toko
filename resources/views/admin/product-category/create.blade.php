...
<div class="card mb-4">
    ...
    <form action="{{ route('product-category.store') }}" method="post" id="CategoryForm" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 ms-3 me-3">
            <label for="category_name" class="form-label">Category Name</label>
            <div class="border-contrast p-1 rounded"> 
                <input type="text" class="form-control text-white border-0" id="category_name" name="category_name" placeholder=" Category Name" aria-label="category_name" value="{{ old('category_name') }}" class="text-dark">
            </div>
            @error('category_name')
