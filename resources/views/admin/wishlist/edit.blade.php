            ...
            <div class="border-contrast p-1 rounded"> 
                <select class="form-select text-white border-0" id="customer_id" name="customer_id">
                    ...
                    @foreach($customers as $customer)
                        <option value="{{ $customer->id }}" class="text-dark" {{ $wishlist->customer_id == $customer->id ? 'selected' : '' }}>{{ $customer->name }}</option>
                    @endforeach
                </select>
            </div>
            @error('customer_id')
            ...
            <div class="border-contrast p-1 rounded"> 
                <select class="form-select text-white border-0" id="product_id" name="product_id">
                    ...
                    @foreach($products as $product)
                        <option value="{{ $product->id }}" class="text-dark" {{ $wishlist->product_id == $product->id ? 'selected' : '' }}>{{ $product->product_name }}</option>
                    @endforeach
                </select>
            </div>
            @error('product_id')
